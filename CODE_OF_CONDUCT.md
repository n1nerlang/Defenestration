...
## Our Pledge
We, as contributors and maintainers of the Defenestration project, pledge to make participation in our community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, caste, color, religion, or sexual identity and orientation.
...
* **Giving and gracefully accepting constructive feedback** on code, scripts, and optimizations.
* **Accepting responsibility** and apologizing to those affected by our mistakes, and learning from the experience.
* **Focusing on what is best for the overall community** and the efficiency of the software.
...
* Other conduct which could reasonably be considered inappropriate in a professional or open-source development setting.
...
This Code of Conduct applies within all project spaces (including the official GitHub repository, issue trackers, and pull requests), and it also applies when an individual is officially representing the project or its community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by opening a confidential or public report via the **GitHub Issues** tracker on the official repository. All complaints will be reviewed and investigated promptly and fairly.
